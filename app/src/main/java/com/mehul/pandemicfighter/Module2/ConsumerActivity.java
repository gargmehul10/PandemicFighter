...
public class ConsumerActivity extends AppCompatActivity implements OnMapReadyCallback, PermissionsListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String aadharNumber = details.get("Aadhar");
    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        ...
        mapboxMap.setStyle(Style.MAPBOX_STREETS, style -> {
            ...
            mapboxMap.setOnInfoWindowClickListener(marker -> {
                ...
                {
                    Toast.makeText(ConsumerActivity.this, "open dialog 1 ",Toast.LENGTH_SHORT).show();
                    openDialog(marker);
                    Toast.makeText(ConsumerActivity.this, "open dialog 2 ",Toast.LENGTH_SHORT).show();
                }
                return false;
            });
        });
